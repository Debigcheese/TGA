...
void GameWorld::Update(float aTimeDelta)
{
	...
	//const bool escDown = false;
	//if (escDown && !myPrevEscDown)
	//{
	//	HandlePause();
	//}
	//myPrevEscDown = escDown;
	...
	//myGameState->HandleScore(myHelicopter, myTerrain);
	//GenerateTerrain();
...
void GameWorld::HandlePause() const
{
	...
	{
		myGameState->SetPauseGame(false);
		myHelicopter->SetActive(true);
