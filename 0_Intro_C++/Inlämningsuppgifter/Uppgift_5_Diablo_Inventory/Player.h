...
public:
    ...
    void TakeDamage(float aDamage, std::string aEnemyName);
    ...
    float GetDamage(const Attributes& aAttributes) const;
    float GetMaxHealth(const Attributes& aAttributes) const;
    float GetCarryCapacity(const Attributes& aAttributes) const;
    float GetDefense(const Attributes& aAttributes) const;
