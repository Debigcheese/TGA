...
Diablo::Diablo() : myWorldGenerator(), myWorldMap(), myPlayerController(myWorldMap, myPlayer), myPlayer(myWorldMap)
{
}

void Diablo::RunDiablo()
{
    myWorldGenerator.GenerateRooms(myWorldMap.GetRooms());
    myWorldGenerator.GenerateDoors(myWorldMap.GetDoors());
